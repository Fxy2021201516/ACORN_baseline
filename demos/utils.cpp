...
// MACRO
#define DATASETS_DIR "../ACORN_data/words"
...
std::string get_file_name(std::string dataset, bool is_base) {
    if (dataset == "sift1M" || dataset == "sift1M_test") {
        return DATASETS_DIR + std::string("/datasets/sift_") +
                (is_base ? "base" : "query") + ".fvecs";
    } else if (dataset == "sift1B") {
        return DATASETS_DIR + std::string("/datasets/bigann_") +
                (is_base ? "base_10m" : "query") + ".fvecs";
    } else if (dataset == "tripclick") {
        return DATASETS_DIR + std::string("/datasets/") +
        ...
        return DATASETS_DIR + std::string("/datasets/") +
                (is_base ? "words_base" : "words_query") + ".fvecs";
    } else {
